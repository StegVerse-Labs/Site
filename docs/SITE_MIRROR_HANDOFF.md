...
15. Site: run python scripts/check_site_mirror_evidence_packet.py.
16. Publisher: update live-dispatch receipt.
17. Publisher: update verification tracker to activated.
18. Publisher: update activation-status to activated.
```
...
Pending: live Publisher dry-run dispatch, dry-run receipt commit, live Publisher dispatch, Site workflow evidence, public alias verification, Site evidence packet completion, Publisher receipt update, Publisher verification tracker activation, and Publisher activation-status update.
```

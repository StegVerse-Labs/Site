...
assert any(marker in handoff for marker in ("State: IMPLEMENTATION_CLAIM_ADMISSION","State: VALIDATION_CLAIM_ADMISSION","State: SOURCE_MERGED_PENDING_CLAIM_RELEASE","State: RELEASED"))

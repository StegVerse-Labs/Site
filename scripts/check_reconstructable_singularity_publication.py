...
def main() -> int:
    ...
    require("old Site URL remains only as a compatibility redirect" in handoff, "current handoff missing redirect boundary")
    ...
    require("papers/reconstructable-singularity.html" in claim.get("public_pages", []), "current route missing from registry")

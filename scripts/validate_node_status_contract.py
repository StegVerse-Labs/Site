...
if contract_path.exists():
    ...
    expected = [
        ...
        "PRIVATE_SOVEREIGN",
        "MAIN_ECOSYSTEM",
        "PRIVATE_SOVEREIGN_STEGOS",
        "ECOSYSTEM_SOVEREIGN_STEGOS",
    ]
...
if resolver_path.exists():
    ...
    for marker in [
        ...
        'indexedDB.databases',
        'never open/create IndexedDB merely to discover whether a Node exists',
        'explicitConnect',
        'registerDevice()',
        'explicitSelectNodeClass',
        'NODE_CLASS_REQUESTED',
        'NODE_CLASS_ESTABLISHED',
        'ECOSYSTEM_ELIGIBILITY_REQUIRED',
    ]:
...
if explainer_path.exists():
    ...
    for marker in [
        ...
        "Observation does not authorize transition.",
        "Node established does not mean capability established.",
        'href="nodes.html"',
    ]:
...
if product_path.exists():
    ...
    for label in [
        ...
        "Main Ecosystem Node",
        "Private Sovereign StegOS Node",
        "Ecosystem Sovereign StegOS Node",
        "Node status describes capability and sovereignty—not rank.",
        "Choose where your StegVerse capability lives.",
    ]:

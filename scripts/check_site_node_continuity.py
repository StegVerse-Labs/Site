...
def main():
    ...
    for marker in [
        ...
        "Register this device","Set up your KnowledgeVault","Create browser-local KV","Connect an existing KV","KV_RELATIONSHIP_NOT_ESTABLISHED","Add Personal Information","Vault &amp; Connections","Verify your KnowledgeVault",

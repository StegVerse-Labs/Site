...
EXPECTED_SITE_MERGE = "ec8b5136ff9281ea37e861281f9428c7c283fbe4"
REPORT = Path(
    os.environ.get(
...
def fetch(url: str) -> tuple[int, str, bytes]:
    req = urllib.request.Request(
        url,
        headers={"User-Agent": "StegVerse-StegfFin-Publication-Observer/1.0"},
    )
        ...
        report.update(
            {
                ...
                "tls_verified": page_final.startswith("https://") and ui_final.startswith("https://"),

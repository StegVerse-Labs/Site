...
def main() -> None:
    ...
    require("INTR_TRANSPORT_PENDING" in client, "pending_intr_transport_not_distinguished")
    ...
    print("HIL_PENDING_INTR_TRANSPORT=hil-receipt.html")
    print("HIL_SUBMIT_READINESS_PREFLIGHT_REQUIRED=false")

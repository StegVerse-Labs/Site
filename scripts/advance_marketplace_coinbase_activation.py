...
# rejected rather than consumed so this script can be executed by a StegVerse-owned
# worker without transferring credential or control-plane authority to GitHub Actions.
...
def reject_credentials() -> list[str]:

...
def main():
    ...
    for marker in ['#playPause','#adaptiveNext','#progress','playback_started','adaptive_selection_decision','playback_paused','"browser_audio_execution_verified"','"audible_output_confirmed":False','"activation_authority_granted":False','reports/stegmusic-browser-execution.json','event_types','page_errors']:

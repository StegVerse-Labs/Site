...
def main():
    ...
    for marker in ['#playPause','[data-six-track]','[data-six-track="3"]','#progress','StegMusicSixTrackRegistry','getTrackCount','stegmusic_six_track_registry_ready','enhanced_media_playback_started','browser_audio_execution_verified','audible_output_confirmed','activation_authority_granted','stegmusic-browser-execution.json','REPORT','event_types','page_errors']:

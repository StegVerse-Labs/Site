...
REQUIRED_GENERAL_CLIENT = [
    ...
    "result?.source_observation===true",
    "'source-observation'",
    "result?.model_execution===false&&result?.deterministic_execution===true",
    "'deterministic-capability'",
    "response.dataset.executionKind=evidenceKind(result)",
    "response.dataset.sourceObservation='true'",
    "response.dataset.sourceProvider=String(result.source_provider)",

...
generated=(ROOT/"assets/generated/site-browser-intr-connectors.js").read_text()
handoff=(ROOT/"docs/SV002_PUBLIC_OBSERVATION_MIRROR_HANDOFF.md").read_text()
required_html=["id=\"nodeBadge\"","STEGVERSE NODE CHECKING","Open observation Interlock","assets/stegverse-node-continuity.js","assets/evaluator-intr-connector.js","stegos-node/sv002-intr-sync.js","assets/sv002-observe.js"]
...
for x in required_js:
    assert x in js+generated, x
for x in ["STEGVERSE NODE REQUIRED","STEGVERSE NODE CONFIRMED","STEGVERSE NODE CHECK FAILED"]:
    assert x in js, x
